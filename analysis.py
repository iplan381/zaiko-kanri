...
if not df_log_raw.empty:
    ...
    if sel_month_str != "すべて表示":
        ...
        df_last_year_base = df_out_all[(df_out_all["年"] == (sel_year - 1)) & (df_out_all["月"] == sel_month_int)]
    else:
        df_final = df_this_year
        df_last_year_base = df_out_all[df_out_all["年"] == (sel_year - 1)]
    ...
    if sel_item != "すべて表示":
        ...
        df_last_year_base = df_last_year_base[df_last_year_base["商品名"] == sel_item]
        ...
        if sel_size != "すべて表示":
            ...
            df_last_year_base = df_last_year_base[df_last_year_base["サイズ"] == sel_size]
            ...
            if sel_loc != "すべて表示":
                ...
                df_last_year_base = df_last_year_base[df_last_year_base["地名"] == sel_loc]
